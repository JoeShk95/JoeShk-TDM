...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid, COLOR_RED,  " יוצרי המוד רועי עומר ואור כהן   ");
    SendClientMessage(playerid, COLOR_RED,  " אדמינים בסרבר: ברק שמטוב רועי עומר ואור כהן  ");
    ...
    SendClientMessage(playerid, COLOR_YELLOW, "תהנו מחפשים אדמינים נא לפנות לרוי קילר תודה  ");
...
//==============================================================================
	if(strcmp(cmd, "/help", true) == 0) {
		...
		SendClientMessage(playerid, COLOR_RED, "            roy_killer-מתכנת ראשי .");
...
//==============================================================================
    ...
    SendClientMessage(playerid, COLOR_ORANGE, " /drift  לאזור הדריפט ");
     ...
     SendClientMessage(playerid, COLOR_ORANGE,"/fitness למכון כושר");
...
//==============================================================================
    ...
    SendClientMessage(playerid, COLOR_ORANGE,"/drift לאזור הדרפיטים");
	...
	SendClientMessage(playerid, COLOR_ORANGE, "/water אזור מתחת למים");
...
//==============================================================================
		...
		SendClientMessage(playerid, COLOR_GREEN,"ניקת לעצמך תצ'אט!");
...
//==============================================================================
    ...
    format(string, sizeof(string), " afk נכנס למצב  %s", playerName);
...
SendClientMessage(playerid,0x0000BBAA,"afk יצא ממצב");
...
new VehicleID;
VehicleID = GetPlayerVehicleID(playerid);
SendClientMessage(playerid,0x0000BBAA," הגעתם לאזור הקפיצה תזהרו לא ליפול :)");
...
new VehicleID;
VehicleID = GetPlayerVehicleID(playerid);
SendClientMessage(playerid,0x0000BBAA," !!הגעתם לאזור טיולי הגיפים תהנו ");
SetVehiclePos(VehicleID,-727.5442,2306.2537,128.2241);
}else{
...
AddStaticVehicle(590,645.8505,883.1459,-37.8390,0.0000,0,0); //
AddStaticVehicle(557,570.3670,884.1910,-42.9931,56.5189,1,1); //
AddStaticVehicle(557,559.9496,891.7937,-42.7818,237.8700,1,1); //
AddStaticVehicle(432,533.7163,915.4376,-42.6839,184.2745,43,0); //
AddStaticVehicle(432,559.7795,925.8121,-42.9078,10.9525,43,0); //
AddStaticVehicle(406,568.5120,892.0380,-41.7910,149.2112,1,1); //
AddStaticVehicle(406,557.6736,883.8925,-41.8376,302.2789,1,1); //
AddStaticVehicle(568,548.8705,916.2115,-37.7134,63.5942,37,0); //
AddStaticVehicle(568,517.0954,851.9729,-42.6466,160.4860,37,0); //
AddStaticVehicle(568,527.3041,845.8073,-43.0913,308.1212,37,0); //
AddStaticVehicle(564,671.3405,929.3858,-41.5218,152.4714,0,0); //
AddStaticVehicle(564,673.3230,928.6787,-41.5868,166.6651,0,0); //
AddStaticVehicle(564,675.9532,927.0253,-41.6904,168.8529,0,0); //
AddStaticVehicle(564,637.8668,826.6902,-41.0095,84.5129,0,0); //
AddStaticVehicle(548,590.1489,873.6072,-36.3369,89.5669,1,1); //
AddStaticVehicle(548,536.6014,883.6138,-34.6527,253.6733,1,1); //
AddStaticVehicle(546,684.2805,840.9287,-43.2366,57.8547,3,87); //
AddStaticVehicle(546,680.7535,834.1758,-43.2366,60.4674,3,87); //
AddStaticVehicle(539,486.3822,790.2736,-22.6264,321.9047,61,98); //
AddPlayerClass(0,493.0612,794.2681,-21.9946,294.0140,0,0,0,0,0,0); //
AddStaticVehicle(539,489.3725,786.9106,-22.6643,315.9724,75,91); //
AddStaticVehicle(532,514.4077,821.7960,-23.5616,268.1383,0,0); //
AddStaticVehicle(531,516.2618,827.7729,-25.4157,273.5268,2,35); //
AddStaticVehicle(522,489.4644,784.1080,-22.4430,309.6415,8,82); //
AddStaticVehicle(522,489.5646,783.1870,-22.4448,300.3918,39,106); //
AddStaticVehicle(432,465.0652,887.4894,-28.3775,94.3064,43,0); //
AddStaticVehicle(432,464.6068,878.2133,-28.3427,106.1383,43,0); //
AddStaticVehicle(432,467.1801,872.0337,-28.3622,113.2908,43,0); //
AddStaticVehicle(539,421.8611,901.7868,1.7639,262.9456,79,74); //
